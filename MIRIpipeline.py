...
def rundet1(filenames):
	...
	det1.superbias.skip = False           #new
	det1.refpix.skip = True
	det1.linearity.skip = False           #new
	det1.persistence.skip = False         #new
	det1.dark_current.skip = False        #new
	det1.jump.skip = False                #new
...
#	spec3.cube_build.scale1 = 0.196
#	spec3.cube_build.scale2 = 0.196
	spec3(filename)


#Uber-cube pipeline
def runspec3_all(filename):
	crds_config = Spec3Pipeline.get_config_from_reference('l3asn.json')
	spec3 = Spec3Pipeline.from_config_section(crds_config)
	spec3.output_dir = '../stage3'
	spec3.save_results = True
	spec3.assign_mtwcs.skip = False
